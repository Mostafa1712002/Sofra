        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('paid', 'فتلرة بالمدفوع ') !!}
                        {!! Form::text('paid_from', null, ['class' => 'form-control mb-2 ', 'placeholder' => 'من']) !!}
                        {!! Form::text('paid_to', null, ['class' => 'form-control', 'placeholder' => 'إلي']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('payment_date', 'فتلرة تاريخ الدفع') !!}
                        <br>
                        <span class="text-bold text-info">من</span>
                        {!! Form::date('payment_date_from', null, ['id' => 'payment_date', 'class' => 'form-control']) !!}
                        <span class="text-bold text-info">إلي</span>
                        {!! Form::date('payment_date_to', null, ['id' => 'payment_date', 'class' => 'form-control']) !!}
                    </div>
            ...
            <div class=" @if (count($records)) card @endif mg-b-20">
                <div class="@if (count($records)) card-header @endif pb-0">
                    ...
                    @if (auth()->user()->can('payment-create'))
                        <div class="d-flex justify-content-center mt-2 mb-2">
                            <a type="button" href="{{ route('payment.create') }}" style="color:white"
