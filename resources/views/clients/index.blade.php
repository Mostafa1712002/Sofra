    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">عملية فلترة للعملاء</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'فلترة باسم العميل']) !!}
                </div>

                <div class="form-group">
                    {!! Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'فلترة بالبريد الألكتروني
                    للعميل']) !!}
                </div>
        ...
        <div class=" @if (count($records)) card @endif mg-b-20">
            <div class="@if (count($records)) card-header @endif pb-0">
                <div class="d-flex justify-content-center">
                    <h4 class="card-title mg-b-0">جدول العملاء </h4> <i class="mdi mdi-dots-horizontal text-gray"></i>
                </div>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="border-bottom-0 sorting" tabindex="0" rowspan="1" colspan="1"
                                                style="width: 500px;">اسم العميل </th>
                                            <th class="border-bottom-0 sorting" tabindex="0" rowspan="1" colspan="1"
                                            ...
                                            <th class="border-bottom-0 no-after sorting" tabindex="0" rowspan="1"
                                                colspan="1" style="width: 800px;"> حذف <b class="text-secondary">|</b>
                                                التنشيط</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd" id="form{{ $record->id }}">
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-6" id="active-div{{ $record->id }}">
                                                        @if ($record->active == 1)
                                                        <div style="cursor: pointer;" data-token="{{ csrf_token() }}"
                                                            data-id="{{ $record->id }}" data-active="active"
                                                            data-route="{{ route('client.active') }}"
                                                            class="active- text-info">
                                                            <i class="fas fa-check"></i>
                                                        </div>
                                                        @else
                                                        <div style="cursor: pointer;" data-token="{{ csrf_token() }}"
                                                            data-id="{{ $record->id }}" data-active="de-active"
                                                            data-route="{{ route('client.active') }}"
